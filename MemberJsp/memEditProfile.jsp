...
<%-- <font size="5" color="orange">SMS Alert..</font><img src="<%=request.getContextPath() %>/images/download (2).jpg" width="50" height="50"> --%>
	...
	<div id="page">
		<div id="page-bgtop">
			<div id="page-bgbtm">
				<div id="content">
							<form action="<%=request.getContextPath()%>/EditIndvMemServlet" method="post">
							<table width="450" height="550" bgcolor="white">
							<tr><td colspan="3" align="center"><h3>Edit Profile</h3></td></tr>
									...
									%>
												...
												<tr>
													...
													<td><font color="black">:</font></td>
													<td align="center"><input type="text" name="pwd" value="<%=rs.getString(3)%>"/></td>
												</tr>
										
												<tr>
													<td align="center"><font color="black">User Type</font></td>
													<td><font color="black">:</font></td>
													<td align="center"><input type="text" name="usertype" value="<%=rs.getString(4)%>" readonly="readonly"/></td>
												</tr>
												...
												<tr>
													...
													<td><font color="black">:</font></td>
													<td align="center"><input type="text" name="email" value="<%=rs.getString(10)%>"
													pattern="\w+([-+.]\w+)*@\w+([-.]\w+)*\.\w+([-.]\w+)*" 
													required="yes"/></td>
												</tr>
												...
												<tr>
													...
													<td><font color="black">:</font></td>
													<td align="center"><input type="text" name="pno" value="<%=rs.getString(11)%>"
														pattern="[7-9]{1}[0-9]{9}"
														required="yes"/></td>
												</tr>
											...
											%>
												...
												<tr>
													<td colspan="11" align="center"><input type="submit" value="Edit"  onclick="return validateSignUp()"/></td>
												</tr>
										</table>
							</form>
						</div>
