...
public final class addBookCatg_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("<title>Add Book Category page</title>\r\n");
      ...
      out.write("\r\n");
      out.write("\tvar catname=MyForm.catname;\r\n");
      out.write("\tif(catname.value.length==0 || catname==\"\" || catname==null)\r\n");
      out.write("\t{\r\n");
      out.write("\t\talert(\"Please enter the category name\");\r\n");
      out.write("\t\tcatname.focus();\r\n");
      out.write("\t\treturn false;\r\n");
      out.write("\t}\r\n");
      out.write("\t\r\n");
      out.write("\tvar desc=MyForm.desc;\r\n");
      out.write("\tif(desc.value.length==0 || desc==\"\" || desc==null)\r\n");
      out.write("\t{\r\n");
      out.write("\t\talert(\"Please enter the Description\");\r\n");
      out.write("\t\tdesc.focus();\r\n");
      out.write("\t\treturn false;\r\n");
      out.write("\t}\r\n");
      out.write("\t\r\n");
      out.write("\telse\r\n");
      ...
      out.print(request.getContextPath());
      out.write("/AddBookCatgServlet\" method=\"post\">\r\n");
      out.write("\t\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t\t<table width=\"400\" height=\"450\" bgcolor=\"white\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t\t\t\t<tr bordercolor=\"white\"><td colspan=\"3\" align=\"center\"><h3>Add Book Category </h3></td></tr>\r\n");
      out.write("\t\t\t\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<td align=\"center\"><font color=\"Black\">Category Name</font></td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<td><font color=\"Black\">:</font></td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<td align=\"center\"><input type=\"text\" name=\"catname\" size=\"25\"></td>\r\n");
      out.write("\t\t\t\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<td align=\"center\"><font color=\"Black\">Description</font></td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<td><font color=\"Black\">:</font></td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<td align=\"center\"><textarea rows=\"6\" cols=\"24\" name=\"desc\"></textarea></td>\r\n");
      out.write("\t\t\t\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<td align=\"center\" colspan=\"3\"><input type=\"submit\" value=\"Add Category\" onclick=\"return validate()\"></input></td>\r\n");
      out.write("\t\t\t\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t\t</table>\r\n");
      out.write("\t\t\t\t\t\t\r\n");
