...
public final class adminLogin_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("\t\t\t\t\t\t\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t<table height=\"200\" width=\"300\" bgcolor=\"#aabbc\" rules=\"none\" frame=\"box\" border=\"1\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t<tr><td colspan=\"3\" align=\"center\"><font size=\"5\" color=\"blue\">Login</font></td></tr><br></br>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t<td align=\"center\"><font size=\"5\" color=\"blue\">Login Id</font></td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t<td><font color=\"black\">:</font></td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t<td align=\"center\"><input type=\"text\" name=\"loginid\" /></td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t<td align=\"center\"><font size=\"5\" color=\"blue\">Password</font></td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t<td><font color=\"black\">:</font></td>\r\n");
