...
public final class viewSalesDetails_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("\t\t\t\t\t\t\t\t\t\t<tr><td colspan=\"14\" align=\"center\"><h3> Sales Details </h3></td></tr>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t<td><font color=\"Black\">Bill No</font></td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t<td><font color=\"Black\">Bill Date</font></td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t<td><font color=\"Black\">Member code</font></td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t<td><font color=\"Black\">Total cost</font></td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t<td><font color=\"Black\">Discount Cost</font></td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t<td><font color=\"Black\">Tax Amount</font></td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t<td><font color=\"Black\">Net Amount</font></td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t\t\t\t");
      ...
      out.write("\t\t\t\t\t\t\t\t\t\t\t\talert(\"Sorry there are no sales details\");\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t</script>\r\n");
      out.write("\t\t\t\t\t\t\t\t");
