		...
		<div id="page-bgtop">
			<div id="page-bgbtm">
				<div id="content">
						...
						<form action="<%=request.getContextPath()%>/EditBookDetailServlet" method="post">
							<table width="450" height="500" bgcolor="white">
							<tr><td colspan="3" align="center"><h3>Edit Book Details</h3></td></tr>
									
									<%
										String code=request.getParameter("code");
										System.out.println("=====code value in editBookDetail jsp page:" +code);
										...
										sql="select * from m_book where b_code='"+bcode+"'";
										System.out.println(sql);
										
										sql1="select cat_code from m_categories";
										System.out.println(sql1);
										ArrayList<Integer> catCodeList=new ArrayList<Integer>();
										
									    rs1=stmt.executeQuery(sql1);
									    while(rs1.next())
									    {
									    	//System.out.println("rs1 value:" +rs1.next());
									    	catCodeList.add(rs1.getInt(1));
									    }
									    System.out.println("====catcodeList from editBookDetail jsp pade===:" +catCodeList);
									...
									<tr>
										...
										<td align="center"><input type="text" name="code" size="25" value="<%=rs.getInt(1)%>" readonly="readonly"></td>
									</tr>
									
									<tr>
										<td align="center"><font color="Black">Book Name</font></td>
										<td><font color="Black">:</font></td>
										<td align="center"><input type="text" name="bkname" size="25" value="<%=rs.getString(2)%>"></td>
									</tr>
								
							<%int cat_code=rs.getInt(3); %>
									...
									<td align="center">
														<select name="catcode">
																<%
																	...
																	{
																%>
																	<option value="<%=catCodeList.get(i)%>" <% if(cat_code==catCodeList.get(i)){%>  selected="selected" <%} %>><%=catCodeList.get(i)%></option>
																<%
																	}
																%>
								...
								<tr>
									...
									<td><font color="Black">:</font></td>
									<td align="center"><input type="text" name="lang" size="25" value="<%=rs.getString(4)%>"></td>
								</tr>
								
								<tr>
									<td align="center"><font color="Black">Price</font></td>
									<td><font color="Black">:</font></td>
									<td align="center"><input type="text" name="price" size="25" value="<%=rs.getFloat(5)%>"></td>
								</tr>
								
								<tr>
									<td align="center"><font color="Black">Author</font></td>
									<td><font color="Black">:</font></td>
									<td align="center"><input type="text" name="author" size="25" value="<%=rs.getString(6)%>"></td>
								</tr>
																
								<tr>
									<td align="center"><font color="Black">Publication</font></td>
									<td><font color="Black">:</font></td>
									<td align="center"><input type="text" name="publ" size="25" value="<%=rs.getString(7)%>"></td>
								</tr>
								...
								<tr>
									...
									<td><font color="Black">:</font></td>
									<td align="center"><input type="text" name="stock" size="25" value="<%=rs.getInt(8)%>" readonly="readonly"></td>
								</tr>
								...
								<tr>
									...
									<td><font color="Black">:</font></td>
									<td align="center"><input type="text" name="tax" size="25" value="<%=rs.getFloat(9)%>"></td>
								</tr>
								
								<tr>
									<td align="center"><font color="Black">Individual Member Discount</font></td>
									<td><font color="Black">:</font></td>
									<td align="center"><input type="text" name="idisc" size="25" value="<%=rs.getInt(10)%>"></td>
								</tr>
																
								<tr>
									<td align="center"><font color="Black">Corporate Member Discount</font></td>
									<td><font color="Black">:</font></td>
									<td align="center"><input type="text" name="cdisc" size="25" value="<%=rs.getInt(11)%>"></td>
								</tr>
								<tr>
									<td align="center"><font color="Black">Book Description</font></td>
									<td><font color="Black">:</font></td>
									<td align="center"><input type="text" name="bdesc" size="25" value="<%=rs.getString(12)%>"></td>
								</tr>
								...
								<tr>
									...
									<td align="center">
										<select name="bstatus">
												<option value="List" <% if(status.equals("List")){%>  selected="selected" <%} %>>List</option>
												<option value="Hold" <% if(status.equals("Hold")){%>  selected="selected" <%} %>>Hold</option>
												<option value="Expired" <% if(status.equals("Expired")){%>  selected="selected" <%} %>>Expired</option>
										</select>
									</td>
								</tr>	
						...
						%>
								...
								<tr>
									<td align="center" colspan="3"><input type="submit" value="Edit Book Details" onclick="return validate()"></input></td>
								</tr>
