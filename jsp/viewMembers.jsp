...
<%@page import="com.dbconnectors.DbConnector"%><html>
<head>
...
<%-- <font size="5" color="orange">SMS Alert..</font><img src="<%=request.getContextPath() %>/images/download (2).jpg" width="50" height="50"> --%>
		...
		<div id="page">
			<div id="page-bgtop">
				<div id="page-bgbtm">
					<div id="content">
						<table border="1" bgcolor="white" width="750px">
								<tr><td colspan="13" align="center"><h3> Members </h3></td></tr>
								<tr>
									<td align="center"><font color="blue">Code</font></td>
									<td align="center"><font color="blue">Login id</font></td>
									<td align="center"><font color="blue">Password</font></td>
									<td align="center"><font color="blue">User Type</font></td>
									<td align="center"><font color="blue">Company Name</font></td>
									<td align="center"><font color="blue">Contact Name</font></td>
									<td align="center"><font color="blue">Address</font></td>
									<td align="center"><font color="blue">City</font></td>
									<td align="center"><font color="blue">Pincode</font></td>
									<td align="center"><font color="blue">Email</font></td>
									<td align="center"><font color="blue">Phone No</font></td>
									<td align="center"><font color="blue">Status</font></td>
									<td align="center"><font color="blue">Edit</font></td>
								</tr>
									...
									%>
										...
										<tr>
											...
											<td><font color="black"><%=rs.getString(5)%></font></td>
											<td><font color="black"><%=rs.getString(6)%></font></td>
											<td><font color="black"><%=rs.getString(7)%></font></td>
											<td><font color="black"><%=rs.getString(8)%></font></td>
											<td><font color="black"><%=rs.getInt(9)%></font></td>
											<td><font color="black"><%=rs.getString(10)%></font></td>
											<td><font color="black"><%=rs.getString(11)%></font></td>
											<td><font color="black"><%=rs.getString(12)%></font></td>
											<td><a href="<%=request.getContextPath()%>/jsp/EditMember.jsp?code=<%=rs.getInt(1)%>"><font color="black">Edit</font></a></td>
						...
						%>
									<script type="text/javascript">
										alert("Member updation unsuccessfull");
									</script>
						<%			
								}
